...
write.table (tree_boolean, file = "Final2.csv", sep = ",", quote = TRUE, row.names = FALSE)

# tree_pred gives different probabilities of 1631 variables. Here selecting the 
# threshold  as 0.35. So anything above 0.35 is considered as pizza received.
